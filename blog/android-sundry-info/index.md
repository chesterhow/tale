...
* 컴포넌트의 도입 시기 및 커버할 수 있는 정확한 API 번호를 알아야 적용할 수 있는 컴포넌트인지를 알 수 있다.
  ...
  * iOS에 비해 Android는 하위 버전 사용자가 꽤 있어서 쉽게 하위 버전을 버리지 못한다.[^3]
    * 2017년 10월 기준 Marshmallow(23) 가 32.0%, 그 뒤로 Lollipop(21) 6.7%, (22) 21.0%, Nougat(24) 15.8%, (25) 2.0%, Kitkat(19) 14.5%, Jelly Bean (16-18)
...
[^6]: Sketch Text 박스 기준이 아닌, 글자 최하단부터의 여백이며 `includeFontPadding`은 `true`일 때다.