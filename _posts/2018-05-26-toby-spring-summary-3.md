...
author: 박종철
category: spring
description: 반복되는 소스들을 개선하면서 JDBC 템플릿(JdbcTemplate)이 어떻게 지금의 모습을 갖췄는지 설명있는 챕터3을 요약해본다.
---
...
토비의 스프링 챕터3 템플릿에서는 이 것을 개선하면서 JDBC 템플릿(JdbcTemplate)이 어떻게 지금의 모습을 갖췄는지 잘 설명되어있다.
